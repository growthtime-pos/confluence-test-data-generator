"""
Base classes for Confluence API interactions.
...
class ConfluenceAPIClient:
    """Base class for Confluence API interactions with rate limiting and session management."""
    ...
    def _create_session(self) -> requests.Session:
        ...
        # This reduces TCP handshake overhead for repeated requests to Confluence
        adapter = HTTPAdapter(
    ...
    def _api_call(
        ...
        Args:
            ...
            base_url: Override base URL (for different API versions etc.)
        """
        if base_url is None:
            base_url = f"{self.confluence_url}/api/v2"
    ...
    async def _get_async_session(self) -> aiohttp.ClientSession:
        ...
        if self._async_session is None or self._async_session.closed:
            ...
            # limit_per_host=50: Connections per host (Confluence API)
    ...
    def _init_text_pool(cls) -> None:
        ...
        - medium (5-15 words): page descriptions, property descriptions
